---
title_en: Tattvartha Sutra · Chapter 1
title_sk: तत्त्वार्थ सूत्र
category: sutra
...
authorCard: |
  ...
  In the Digambara tradition, Tattvartha is read with Acharya Pujyapada's *Sarvarthasiddhi* commentary, which establishes the canonical Digambara reading. The Shvetambara tradition reads it with the *Tattvartha-bhāṣya* (often considered to be by Umaswati himself) and Siddhasena Gani's commentary.

  Almost nothing is preserved about Umaswami's life. What survives is the text itself — 357 *sutras* across 10 chapters, condensing the entire Jain worldview into the most aphoristic Sanskrit possible. Each sutra is a few words; each opens onto centuries of commentary.

  This library presents Chapter 1 in the Digambara recension, with the *Sarvarthasiddhi* reading as the authoritative interpretation.
---
